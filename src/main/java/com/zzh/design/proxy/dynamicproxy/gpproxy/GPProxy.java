...
public class GPProxy {
    ...
    private static String generateSrc(Class<?>[] interfaces){
        ...
        if(interfaces.length>65535){
            throw new RuntimeException("interface limit 65535");
        }
        StringBuilder sb = new StringBuilder();
        sb.append("package com.zzh.design.proxy.dynamicproxy.gpproxy;"+ln);
        sb.append("import com.zzh.design.proxy.dynamicproxy.gpproxy.GPInvocationHandler;"+ln);
        sb.append("import com.zzh.design.proxy.dynamicproxy.gpproxy.GPProxy;"+ln);
        sb.append("public class $proxy0 implements "+interfaces[0].getName()+"{"+ln);
        sb.append("private GPInvocationHandler h;"+ln);
        sb.append("public $proxy0(GPInvocationHandler handler){"+ln);
            sb.append("this.h = handler;"+ln);
        sb.append("}");
